...
class pacemaker::stonith::fence_drac5 (
  ...
  if($ensure == absent) {
    exec { "Delete stonith::fence_drac5 for ${resource_name}":
    ...
    exec { "Create stonith::fence_drac5 for ${resource_name}":
    ...
    exec { "Add non-local constraint stonith::fence_drac5 for ${resource_name}":
