...
class pacemaker::stonith::fence_rhevm (
  ...
  if($ensure == absent) {
    exec { "Delete stonith::fence_rhevm for ${resource_name}":
    ...
    exec { "Create stonith::fence_rhevm for ${resource_name}":
    ...
    exec { "Add non-local constraint stonith::fence_rhevm for ${resource_name}":
