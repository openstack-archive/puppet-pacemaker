...
class pacemaker::stonith::fence_ipdu (
  ...
  if($ensure == absent) {
    exec { "Delete stonith::fence_ipdu for ${resource_name}":
    ...
    exec { "Create stonith::fence_ipdu for ${resource_name}":
    ...
    exec { "Add non-local constraint stonith::fence_ipdu for ${resource_name}":
