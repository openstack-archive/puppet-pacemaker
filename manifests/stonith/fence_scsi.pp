...
class pacemaker::stonith::fence_scsi (
  ...
  if($ensure == absent) {
    exec { "Delete stonith::fence_scsi for ${resource_name}":
    ...
    exec { "Create stonith::fence_scsi for ${resource_name}":
    ...
    exec { "Add non-local constraint stonith::fence_scsi for ${resource_name}":
